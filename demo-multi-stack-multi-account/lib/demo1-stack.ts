        ...
        CodeBuildPolicy: new iam.PolicyDocument({
          statements: [
            ...
            new iam.PolicyStatement({
              ...
              resources: [
                `arn:aws:iam::${config.labAccountId}:role/code-deployer-role`,
                `arn:aws:iam::${config.devAccountId}:role/code-deployer-role`,
                `arn:aws:iam::${config.preprodAccountId}:role/code-deployer-role`,
                `arn:aws:iam::${config.prodAccountId}:role/code-deployer-role`,
              ],
            }),
            new iam.PolicyStatement({
              actions: [
